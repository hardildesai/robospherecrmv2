...
export const LoginPage: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 w-full h-full bg-[#09090b] text-white p-4 sm:p-8 flex items-center justify-center font-sans overflow-y-auto">
            ...
            {/* MOBILE: Simple centered layout; DESKTOP: Bento grid */}
            <div className="w-full max-w-[1200px] relative">

                {/* MOBILE LAYOUT (< md): Just branding + login form */}
                <div className="md:hidden flex flex-col items-center justify-center min-h-[80vh] gap-8 py-8">
                    <AnimatePresence>
                        {!isSuccess && (
                            <>
                                {/* Mobile Brand */}
                                ...
                                >
                                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-4 text-black mx-auto">
                                        <Command className="w-10 h-10" />
                                    </div>
                                    <h1 className="text-3xl font-bold tracking-tight mb-2">RoboSphere</h1>
                                ...
                                <motion.div
                                    ...
                                    className={`w-full max-w-md p-6 sm:p-8 rounded-3xl shadow-2xl ${isError ? 'bg-red-50 border-2 border-red-500' : 'bg-white'}`}
                                >
                                    <div className="mb-6">
                                        <h3 className={`text-2xl font-bold mb-2 ${isError ? 'text-red-900' : 'text-black'}`}>
                                            {isError ? 'Access Denied' : 'Welcome Back'}
                                        </h3>
                                        <p className={`${isError ? 'text-red-600' : 'text-slate-500'}`}>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div className="space-y-2">
                                            <label className={`text-xs font-bold uppercase tracking-wide ${isError ? 'text-red-400' : 'text-slate-400'}`}>
                                                ID / Username
                                            </label>
                                            <input
                                                type="text"
                        ...
                        {!isSuccess && (
                            <>
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 0.5 }}
                                    className="col-span-1 row-span-1 bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col justify-between backdrop-blur-xl hover:bg-white/10 transition-colors duration-300"
                                >
                                    <div>
                                ...
                                <motion.div
                                    ...
                                    className="col-span-2 row-span-1 bg-[#1a1a1a] border border-white/5 rounded-3xl p-6 flex items-center justify-between relative overflow-hidden group"
                                >
                    ...
                    <AnimatePresence>
                        {!isSuccess && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, scale: 0.95, filter: 'blur(10px)' }}
                                className={`col-span-2 row-span-2 p-8 flex flex-col justify-center relative overflow-hidden shadow-2xl rounded-3xl z-20 transition-colors duration-300 ${isError ? 'bg-red-50 border-2 border-red-500 shadow-red-500/20' : 'bg-white'
                                    }`}
                            >
                        ...
                        {!isSuccess && (
                            <>
                                ...
                                <motion.div
                                    ...
                                    className="col-span-1 row-span-2 bg-gradient-to-b from-indigo-500 to-purple-600 rounded-3xl p-6 text-white flex flex-col justify-between shadow-lg shadow-purple-500/20"
                                >
                                    <div>
                                ...
                                <motion.div
                                    ...
                                    className="col-span-1 row-span-1 bg-[#1a1a1a] border border-white/5 rounded-3xl p-0 relative overflow-hidden group"
                                >
                                    {/* Abstract Map Dots */}
                                ...
                                <motion.div
                                    ...
                                    className="col-span-1 row-span-1 bg-emerald-500/10 border border-emerald-500/20 rounded-3xl p-6 flex flex-col justify-center items-center text-center backdrop-blur-sm"
                                >
